  ...
  render() {
    return (
      <div>
        ...
        {/* now in order to rerender/remount the page when we press the category we have to pass the keys so that the react understand that its has to render the page again */}
